...
define("mysql_database", default = "jmt.im", help = "community database name")
define("mysql_user", default = "jmt.im", help = "community database user")
define("mysql_password", default = "jmt.im", help = "community database password")
